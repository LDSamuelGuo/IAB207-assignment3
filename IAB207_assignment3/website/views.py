...
@bp.route('/my_accountInformation')
@login_required
def my_accountInformation():
    return render_template('events/accountInformation.html', heading='My accountInformation', events=current_user.created_events)
